...
class _MyAppState extends State<MyApp> {
  ...
  initializePrefs() async {
    ...
    String apiPath = "http://192.168.99.159/eform/public/";
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // Mandalay Contractor
       '/mandalay/contractor/c_form01_rules_mdy': (context) => CForm01RulesMdy(),
        '/mandalay/contractor/c_form02_promise_mdy': (context) => CForm02PromiseMdy(),
        ...
        '/mandalay/contractor/c_form08_ownership_mdy': (context) =>
            CForm08Ownership(),
        '/mandalay/contractor/c_form09_allow_mdy': (context) => CForm09AllowMdy(),
        '/mandalay/contractor/c_form10_live_mdy': (context) => CForm10LiveMdy(),
        '/mandalay/contractor/c_form11_y_c_d_c_mdy': (context) => CForm11YCDCMdy(),
        '/mandalay/contractor/c_form12_meter_bill_mdy': (context) =>
            CForm12MeterBillMdy(),

        //Mandalay transformer
         '/mandalay/transformer/t_form01_rules_mdy': (context) => TForm01RulesMdy(),
        '/mandalay/transformer/t_form02_promise_mdy': (context) => TForm02PromiseMdy(),
        '/mandalay/transformer/t_form03_money_type_mdy': (context) => TForm03MoneyMdy(),
        '/mandalay/transformer/t_form04_info_mdy': (context) => TForm04InfoMdy(),
        '/mandalay/transformer/t_form05_n_r_c_mdy': (context) => TForm05NRCMdy(),
        ...
        '/mandalay/transformer/t_form08_ownership_mdy': (context) =>
            TForm08OwnershipMdy(),
        '/mandalay/transformer/t_form09_allow_mdy': (context) => TForm09LicenseMdy(),
