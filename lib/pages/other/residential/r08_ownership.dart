...
class R08Ownership extends StatefulWidget {
  const R08Ownership({Key? key}) : super(key: key);

  @override
  State<R08Ownership> createState() => _R08OwnershipState();
}

class _R08OwnershipState extends State<R08Ownership> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(context, 'other_r_overview',
