...
class R06Household extends StatefulWidget {
  const R06Household({Key? key}) : super(key: key);

  @override
  State<R06Household> createState() => _R06HouseholdState();
}

class _R06HouseholdState extends State<R06Household> {
  int? formId;
  ...
  void goToNextPage() async {
    if (edit) {
      ...
      final result = await Navigator.pushNamed(context, 'other_r07_recommend',
