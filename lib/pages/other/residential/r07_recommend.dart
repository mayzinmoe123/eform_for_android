...
class R07Recommend extends StatefulWidget {
  const R07Recommend({Key? key}) : super(key: key);

  @override
  State<R07Recommend> createState() => _R07RecommendState();
}
...
class _R07RecommendState extends State<R07Recommend> {
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(context, 'other_r08_ownership',
