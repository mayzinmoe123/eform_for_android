...
class Rp02Promise extends StatefulWidget {
  const Rp02Promise({Key? key}) : super(key: key);

  @override
  State<Rp02Promise> createState() => _Rp02PromiseState();
}

class _Rp02PromiseState extends State<Rp02Promise> {
  ...
  void goToNextPage(BuildContext context) {
    Navigator.pushNamed(context, 'other_rp03_money');
  }
