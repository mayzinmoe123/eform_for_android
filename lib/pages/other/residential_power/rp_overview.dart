      ...
      child: Column(
        children: [
          ...
          Column(
            ...
            children: [
              Text(
                "          အထက်ပါကိစ္စနှင့်ပတ်သက်၍${result!['address'] ?? '-'}ကျွန်တော်/ကျွန်မ၏${form!['applied_building_type'] ?? '-'} တွင်အိမ်သုံးပါဝါမီတာ ${result!['fee']['name'] ?? '-'} ကီလိုဝပ်တပ်ဆင်သုံးစွဲခွင့်ပြုပါရန်လျှောက်ထားအပ်ပါသည်။",
