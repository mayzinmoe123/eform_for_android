...
class Rp01Rules extends StatefulWidget {
  const Rp01Rules({Key? key}) : super(key: key);

  @override
  State<Rp01Rules> createState() => _Rp01RulesState();
}

class _Rp01RulesState extends State<Rp01Rules> {
 ...
 void stopLoading() {
  ...
  void goToNextPage(BuildContext context) {
    Navigator.pushNamed(context, 'other_rp02_promise');
  }
