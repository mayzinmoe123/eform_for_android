...
class Rp06Household extends StatefulWidget {
  const Rp06Household({Key? key}) : super(key: key);

  @override
  State<Rp06Household> createState() => _Rp06HouseholdState();
}

class _Rp06HouseholdState extends State<Rp06Household> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(context, 'other_rp07_recommend',
