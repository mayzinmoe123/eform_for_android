...
class _TOverviewState extends State<TOverview> {
  ...
  void getFormData() async {
    ...
    var url = Uri.parse('${apiPath}api/other_t_show');
    try {
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            //မှတ်ပုံတင်ရှေ့ဖက်
            mainTitle("မှတ်ပုံတင်/သာသနာရေးကဒ်", showNRCCheck, nrcToggleButton,
                () async {
              startLoading();
