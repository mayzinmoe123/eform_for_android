...
class Cp01Rules extends StatefulWidget {
  const Cp01Rules({Key? key}) : super(key: key);

  @override
  State<Cp01Rules> createState() => _Cp01RulesState();
}

class _Cp01RulesState extends State<Cp01Rules> {
  ...
  void goToNextPage(BuildContext context) {
    Navigator.pushNamed(context, 'other_cp02_promise');
  }
