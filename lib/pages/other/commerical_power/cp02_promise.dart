...
class Cp02Promise extends StatefulWidget {
  const Cp02Promise({Key? key}) : super(key: key);

  @override
  State<Cp02Promise> createState() => _Cp02PromiseState();
}

class _Cp02PromiseState extends State<Cp02Promise> {
  ...
  void goToNextPage(BuildContext context) {
    Navigator.pushNamed(context, 'other_cp03_money');
  }
