...
class C07Recommend extends StatefulWidget {
  const C07Recommend({Key? key}) : super(key: key);

  @override
  State<C07Recommend> createState() => _C07RecommendState();
}

class _C07RecommendState extends State<C07Recommend> {
  int? formId;
  ...
  void goToNextPage() async {
    if (edit) {
      ...
      final result = await Navigator.pushNamed(context, 'other_c08_ownership',
