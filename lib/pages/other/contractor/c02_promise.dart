...
class C02Promise extends StatefulWidget {
  const C02Promise({Key? key}) : super(key: key);

  @override
  State<C02Promise> createState() => _C02PromiseState();
}

class _C02PromiseState extends State<C02Promise> {
  ...
  void goToNextPage(BuildContext context) {
    Navigator.pushNamed(context, 'other_c03_money_type');
  }
