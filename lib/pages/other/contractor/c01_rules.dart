...
class C01Rules extends StatefulWidget {
  const C01Rules({Key? key}) : super(key: key);

  @override
  State<C01Rules> createState() => _C01RulesState();
}

class _C01RulesState extends State<C01Rules> {
  ...
  void goToNextPage(BuildContext context) {
    Navigator.pushNamed(context, 'other_c02_promise');
  }
