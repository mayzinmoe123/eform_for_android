...
class C04Info extends StatefulWidget {
  const C04Info({Key? key}) : super(key: key);

  @override
  State<C04Info> createState() => _C04InfoState();
}

class _C04InfoState extends State<C04Info> {
  int? formId;
  bool isLoading = true;
  ...
  void getTownshipList() async {
    ...
    String division = '1'; // ygn = 2, mdy = 3, other = 1/4/5/..(expect 2/3)
