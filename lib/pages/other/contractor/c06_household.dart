...
class C06Household extends StatefulWidget {
  const C06Household({Key? key}) : super(key: key);

  @override
  State<C06Household> createState() => _C06HouseholdState();
}

class _C06HouseholdState extends State<C06Household> {
  int? formId;
  ...
  void goToNextPage() async {
    if (edit) {
      ...
      final result = await Navigator.pushNamed(context, 'other_c07_recommend',
