...
class CForm07RecommendMdy extends StatefulWidget {
  const CForm07RecommendMdy({Key? key}) : super(key: key);

  @override
  State<CForm07RecommendMdy> createState() => _CForm07RecommendMdyState();
}

class _CForm07RecommendMdyState extends State<CForm07RecommendMdy> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/mandalay/contractor/c_form08_ownership',
