...
class CForm02PromiseMdy extends StatefulWidget {
  const CForm02PromiseMdy({Key? key}) : super(key: key);

  @override
  State<CForm02PromiseMdy> createState() => _CForm02PromiseMdyState();
}

class _CForm02PromiseMdyState extends State<CForm02PromiseMdy> {
  ...
  void goToNextPage(BuildContext context) {
    Navigator.pushNamed(context, 'mdy_c_form03_money_type');
  }
