...
class CForm10LiveMdy extends StatefulWidget {
  ...
  @override
  State<CForm10LiveMdy> createState() =>
      _CForm10LiveMdyState();
}
...
class _CForm10LiveMdyState extends State<CForm10LiveMdy> {
 ...
 Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("လူနေထိုင်ခွင့် အထောက်အထားဓါတ်ပုံ(မူရင်း)",style: TextStyle(fontFamily: "Pyidaungsu"),),
      ),
          ...
          child: Form(
            child: Column(
              children: [
                ...
                SizedBox(height: 10,),
                Text(
                  "လူနေထိုင်ခွင့် ပုံတင်ရန် (မူရင်း) ***",
                  style: TextStyle(
                    fontSize: 23,
