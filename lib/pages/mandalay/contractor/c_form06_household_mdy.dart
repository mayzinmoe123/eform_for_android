...
class CForm06HouseholdMdy extends StatefulWidget {
  const CForm06HouseholdMdy({Key? key}) : super(key: key);

  @override
  State<CForm06HouseholdMdy> createState() => _CForm06HouseholdMdyState();
}

class _CForm06HouseholdMdyState extends State<CForm06HouseholdMdy> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(context, 'mdy_c_form07_recommend',
