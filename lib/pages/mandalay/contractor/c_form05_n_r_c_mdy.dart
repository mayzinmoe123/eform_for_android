...
class CForm05NRCMdy extends StatefulWidget {
  const CForm05NRCMdy({Key? key}) : super(key: key);

  @override
  State<CForm05NRCMdy> createState() => _CForm05NRCMdyState();
}

class _CForm05NRCMdyState extends State<CForm05NRCMdy> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/mandalaly/residential_power/c_form06_household_mdy',
