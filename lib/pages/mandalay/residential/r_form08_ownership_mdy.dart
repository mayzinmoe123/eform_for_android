...
class RForm08OwnershipMdy extends StatefulWidget {
  const RForm08OwnershipMdy({Key? key}) : super(key: key);

  @override
  State<RForm08OwnershipMdy> createState() => _RForm08OwnershipMdyState();
}

class _RForm08OwnershipMdyState extends State<RForm08OwnershipMdy> {
  int? formId;
  ...
  void goToNextPage() async {
    if (edit) {
      ...
      final result = await Navigator.pushNamed(context, 'mdy_r_overview',
