...
class _ROverviewState extends State<ROverview> {
  ...
  void getFormData() async {
    ...
    var url = Uri.parse('${apiPath}api/mdy_r_show');
    try {
        ...
        child: Column(
          children: [
            ...
            mainTitle("ပိုင်ဆိုင်မှုစာရွက်စာတမ်း (မူရင်း)", showOwernshipCheck,
              ...
              final result = await Navigator.pushNamed(
                  context, 'mdy_r_form08_ownership',
                  arguments: {'form_id': formId, 'edit': true});
              startLoading();
              setState(() {
                formId = (result ?? 0) as int;
      ...
      child: Column(
        children: [
          ...
          Column(
            ...
            children: [
              Text(
                "          အထက်ပါကိစ္စနှင့်ပတ်သက်၍ ${result!['address'] ?? '-'} ကျွန်တော်/ကျွန်မ၏ ${form!['applied_building_type'] ?? '-'} တွင်(အိမ်သုံး)မီတာတစ်လုံးတပ်ဆင်သုံးစွဲခွင့်ပြုပါရန်လျှောက်ထားအပ်ပါသည်။",
