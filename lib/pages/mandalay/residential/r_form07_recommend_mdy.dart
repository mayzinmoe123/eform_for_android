...
class RForm07RecommendMdy extends StatefulWidget {
  const RForm07RecommendMdy({Key? key}) : super(key: key);

  @override
  State<RForm07RecommendMdy> createState() => _RForm07RecommendMdyState();
}

class _RForm07RecommendMdyState extends State<RForm07RecommendMdy> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(context, 'mdy_r_form08_ownership',
