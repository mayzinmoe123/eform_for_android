...
class RForm01RulesMdy extends StatefulWidget {
  const RForm01RulesMdy({Key? key}) : super(key: key);

  @override
  State<RForm01RulesMdy> createState() => _RForm01RulesMdyState();
}

class _RForm01RulesMdyState extends State<RForm01RulesMdy> {
                    ...
                    onPressed: () {
                      if (checkedValue == true) {
                        Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) => RForm02PromiseMdy()));
                      }
                      ;
                    },
                    style: ElevatedButton.styleFrom(shape: StadiumBorder()),
