...
class RForm02PromiseMdy extends StatefulWidget {
  const RForm02PromiseMdy({Key? key}) : super(key: key);

  @override
  State<RForm02PromiseMdy> createState() => _RForm02PromiseMdyState();
}

class _RForm02PromiseMdyState extends State<RForm02PromiseMdy> {
  ...
  void goToNextPage(BuildContext context) {
    Navigator.pushNamed(context, 'mdy_r_form03_money');
  }
