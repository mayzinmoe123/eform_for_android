...
class _TForm04InfoMdyState extends State<TForm04InfoMdy> {
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              requiredNoti(),
              SizedBox(height: 13),
              getReligiousCheckBox("ဘာသာ/သာသနာအတွက်ဖြစ်ပါက အမှန်ခြစ်ပါ"),
              SizedBox(height: 13),
              getLightCheckBox("အလင်းရောင်သုံး ထရန်ဖော်မာဖြစ်ပါက အမှန်ခြစ်ပါ"),
              SizedBox(height: 13),
              _getFormRequired("နာမည်အပြည့်အစုံ", nameController),
              _getFormRequired("မှတ်ပုံတင်အမှတ်(ဘာသာ/သာသနာအတွက် ဖြစ်ပါက သာသနာရေးကဒ်အမှတ်)", nrcController,
              ...
              _getFormOptional("လုပ်ငန်းအမည် (ဘာသာ/သာသနာအတွက် ဖြစ်ပါက ဖြည့်ရန်မလိုပါ)", homeNoController),
              _getFormRequired("အဆောက်အဦးပုံစံ၊ အကျယ်အဝန်း၊ အိမ်အမျိုးအစား (ဘာသာ/သာသနာအတွက် ဖြစ်ပါက နေရာ(သို့)ကျောင်းတိုက်အမည်)",
  ...
  Widget getReligiousCheckBox(name) {
    return CheckboxListTile(
      title: Text(
        name,
        style: TextStyle(fontSize: 13),
   ...
   Widget getLightCheckBox(name) {
    return CheckboxListTile(
      title: Text(
        name,
        style: TextStyle(fontSize: 13),
      ),
      value: lightCheckedValue,
      onChanged: (newValue) {
        setState(() {
          lightCheckedValue = newValue!;
        });
      },
      controlAffinity: ListTileControlAffinity.leading, //  <-- leading Checkbox
    );
