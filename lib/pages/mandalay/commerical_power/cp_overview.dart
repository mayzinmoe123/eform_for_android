...
class _CpOverviewState extends State<CpOverview> {
  ...
  void getFormData() async {
    ...
    var url = Uri.parse('${apiPath}api/cp_show');
    try {
        ...
        child: Column(
          children: [
            ...
            mainTitle("အိမ်ထောင်စုစာရင်း (မူရင်း)", showHouseholdCheck,
              ...
              startLoading();
              final result = await Navigator.pushNamed(
                  context, 'mdy_cp_form06_household',
                  arguments: {
                    'form_id': formId,
                    'edit': true,
                  });
            ...
            mainTitle("စည်ပင်သာယာလိုင်စင်", showYCDCCheck, ycdcToggleButton,
                () async {
              startLoading();
              final result = await Navigator.pushNamed(
                  context, 'mdy_cp_form10_y_c_d_c',
                  arguments: {
                    'form_id': formId,
                    'edit': true,
                  });
            ...
            mainTitle("သက်ဆိုင်ရာဝန်ကြီးဌာန ခွင့်ပြုမိန့်", showGovAllowCheck,
                govAllowToggleButton, () async {
              startLoading();
              final result = await Navigator.pushNamed(
