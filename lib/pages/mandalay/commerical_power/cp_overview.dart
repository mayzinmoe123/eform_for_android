    ...
    return SingleChildScrollView(
      child: Container(
       ...
       : Container(),
            ...
            mainTitle(
                "စည်ပင်သာယာလိုင်စင်", showYCDCCheck   , ycdcToggleButton),
            SizedBox(
              height: 10,
            ),
            showYCDCCheck    == true
                ? multiImageFront("စည်ပင်သာယာလိုင်စင်")
                : Container(),
                 SizedBox(
              height: 20,
            ),
            ...
            mainTitle(
                "သက်ဆိုင်ရာဝန်ကြီးဌာန ခွင့်ပြုမိန့်", showGovAllowCheck   , govAllowToggleButton),
            SizedBox(
              height: 10,
            ),
            showGovAllowCheck == true
                ? multiImageFront("သက်ဆိုင်ရာဝန်ကြီးဌာန ခွင့်ပြုမိန့်")
                : Container(),
                 SizedBox(
              height: 20,
            ),
        ...
        children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.start, children: [
            textSpan("အကြောင်းအရာ။   ။",
                "စက်မှုသုံးပါ၀ါမီတာတပ်ဆင်ခွင့်ပြုပါရန်လျှောက်ထားခြင်း။")
          ]),
          SizedBox(
            height: 10,
          ),
          Column(
            ...
            children: [
              Text(
                "          အထက်ပါကိစ္စနှင့်ပတ်သက်၍အမှတ် (142)၊ Innwa၊ 6 block၊ ချမ်းအေးသာစံမြို့နယ်၊ မန္တလေးခရိုင်၊ မန္တလေးတိုင်းဒေသကြီး၊နေကျွန်တေ  ာ်/ကျွန်မ၏80x80 တွင်(အိမ်သုံး)မီတာတစ်လုံးတပ်ဆင်သုံးစွဲခွင့်ပြုပါရန်လျှောက်ထားအပ်ပါသည်။",
...
TableRow _getTableHeader(String d1, List d2) {
  ...
  govAllowToggleButton(){
    setState(() {
      showGovAllowCheck = !showGovAllowCheck;
    });
  }
