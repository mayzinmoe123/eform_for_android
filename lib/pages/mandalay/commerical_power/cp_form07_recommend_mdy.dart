...
class CpForm07RecommendMdy extends StatefulWidget {
  const CpForm07RecommendMdy({Key? key}) : super(key: key);

  @override
  State<CpForm07RecommendMdy> createState() => _CpForm07RecommendMdyState();
}
...
class _CpForm07RecommendMdyState extends State<CpForm07RecommendMdy> {
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/mandalay/commerical_power/cp_form08_ownership_mdy',
