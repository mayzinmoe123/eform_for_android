...
class CpForm01RulesMdy extends StatefulWidget {
  const CpForm01RulesMdy({Key? key}) : super(key: key);

  @override
  State<CpForm01RulesMdy> createState() => _CpForm01RulesMdyState();
}

class _CpForm01RulesMdyState extends State<CpForm01RulesMdy> {
                    ...
                    onPressed: () {
                      if (checkedValue == true) {
                        Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) => CpForm02PromiseMdy()));
                      }
                      ;
                    },
                    style: ElevatedButton.styleFrom(shape: StadiumBorder()),
