...
class CpForm04InfoMdy extends StatefulWidget {
  const CpForm04InfoMdy({Key? key}) : super(key: key);

  @override
  State<CpForm04InfoMdy> createState() => _CpForm04InfoMdyState();
}

class _CpForm04InfoMdyState extends State<CpForm04InfoMdy> {
  int? formId;
  bool isLoading = true;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(context, 'mdy_cp_form05_n_r_c',
