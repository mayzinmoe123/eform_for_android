...
class CpForm06HouseholdMdy extends StatefulWidget {
  const CpForm06HouseholdMdy({Key? key}) : super(key: key);

  @override
  State<CpForm06HouseholdMdy> createState() => _CpForm06HouseholdMdyState();
}
...
class _CpForm06HouseholdMdyState extends State<CpForm06HouseholdMdy> {
  ...
  void goToNextPage(formIdValue) async {
    final result = await Navigator.pushNamed(
        context, '/mandalay/commerical_power/cp_form07_recommend_mdy',
