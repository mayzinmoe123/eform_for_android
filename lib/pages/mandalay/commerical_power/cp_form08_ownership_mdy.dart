...
class CpForm08OwnershipMdy extends StatefulWidget {
  const CpForm08OwnershipMdy({Key? key}) : super(key: key);

  @override
  State<CpForm08OwnershipMdy> createState() => _CpForm08OwnershipMdyState();
}
...
class _CpForm08OwnershipMdyState extends State<CpForm08OwnershipMdy> {
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/mandalay/commerical_power/cp_form09_license_mdy',
