...
class CpForm02PromiseMdy extends StatefulWidget {
  const CpForm02PromiseMdy({Key? key}) : super(key: key);

  @override
  State<CpForm02PromiseMdy> createState() => _CpForm02PromiseMdyState();
}

class _CpForm02PromiseMdyState extends State<CpForm02PromiseMdy> {
 ...
 Widget loading() {
  ...
  void goToNextPage(BuildContext context) {
    Navigator.pushNamed(context, 'mdy_cp_form03_money');
  }
