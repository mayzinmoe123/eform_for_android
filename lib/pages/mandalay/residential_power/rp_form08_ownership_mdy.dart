...
class RpForm08OwnershipMdy extends StatefulWidget {
  const RpForm08OwnershipMdy({Key? key}) : super(key: key);

  @override
  State<RpForm08OwnershipMdy> createState() => _RpForm08OwnershipMdyState();
}
