...
class RpForm07RecommendMdy extends StatefulWidget {
  const RpForm07RecommendMdy({Key? key}) : super(key: key);

  @override
  State<RpForm07RecommendMdy> createState() => _RpForm07RecommendMdyState();
}

class _RpForm07RecommendMdyState extends State<RpForm07RecommendMdy> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/mandalay/residential_power/rp_form08_ownership',
