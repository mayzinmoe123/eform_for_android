...
class CpForm06Household extends StatefulWidget {
  const CpForm06Household({Key? key}) : super(key: key);

  @override
  State<CpForm06Household> createState() => _CpForm06HouseholdState();
}

class _CpForm06HouseholdState extends State<CpForm06Household> {
  int? formId;
  bool edit = false;
