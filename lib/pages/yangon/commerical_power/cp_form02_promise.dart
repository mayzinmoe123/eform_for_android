...
class CpForm02Promise extends StatefulWidget {
  const CpForm02Promise({Key? key}) : super(key: key);

  @override
  State<CpForm02Promise> createState() => _CpForm02PromiseState();
}

class _CpForm02PromiseState extends State<CpForm02Promise> {
  var checkedValue = false;
  bool isLoading = true;
  List<String> rules = [
    "လျှောက်ထားသူသည် ယခု စက်မှုသုံးပါဝါမီတာ လျှောက်ထားခြင်းအတွက် မည်သူကိုမျှ လာဘ်ငွေ၊ တံစိုးလက်ဆောင် တစ်စုံတစ်ရာ ပေးရခြင်းမရှိပါ။",
  ...
  void goToNextPage(BuildContext context) {
    Navigator.pushNamed(context, '/yangon/commerical_power/cp_form03_money');
  }
