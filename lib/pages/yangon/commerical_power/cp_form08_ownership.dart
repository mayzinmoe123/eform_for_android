...
class CpForm08Ownership extends StatefulWidget {
  const CpForm08Ownership({Key? key}) : super(key: key);

  @override
  State<CpForm08Ownership> createState() => _CpForm08OwnershipState();
}

class _CpForm08OwnershipState extends State<CpForm08Ownership> {
  int? formId;
  bool edit = false;
