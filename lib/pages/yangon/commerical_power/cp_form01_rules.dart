...
class CpForm01Rules extends StatefulWidget {
  const CpForm01Rules({Key? key}) : super(key: key);

  @override
  State<CpForm01Rules> createState() => _CpForm01RulesState();
}

class _CpForm01RulesState extends State<CpForm01Rules> {
 ...
 void stopLoading() {
  ...
  void goToNextPage(BuildContext context) {
    Navigator.pushNamed(context, '/yangon/commerical_power/cp_form02_promise');
  }
