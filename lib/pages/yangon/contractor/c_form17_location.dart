...
class CForm17Location extends StatefulWidget {
  const CForm17Location({Key? key}) : super(key: key);

  @override
  State<CForm17Location> createState() => _CForm17LocationState();
}

class _CForm17LocationState extends State<CForm17Location> {
  int? formId;
  ...
  final subTitle = const Text(
    "လျှောက်ထားသူ၏ အဆောက်အဦး တည်နေရာပြမြေပုံ",
    style: TextStyle(
      fontSize: 18,
