...
class CForm05NRC extends StatefulWidget {
  const CForm05NRC({Key? key}) : super(key: key);

  @override
  State<CForm05NRC> createState() => _CForm05NRCState();
}

class _CForm05NRCState extends State<CForm05NRC> {
  int? formId;
