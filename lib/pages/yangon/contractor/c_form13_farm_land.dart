...
class CForm13FarmLand extends StatefulWidget {
  const CForm13FarmLand({Key? key}) : super(key: key);

  @override
  State<CForm13FarmLand> createState() => _CForm13FarmLandState();
}

class _CForm13FarmLandState extends State<CForm13FarmLand> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/yangon/contractor/c_form14_building',
