...
class _CForm18SignState extends State<CForm18Sign> {
  ...
  Widget front() {
    return (frontFiles.length <= 0)
        ? multipleUploadWidget(
            'ရေစက်မီတာလျှောက်ထားရာတွင် ကန်ထရိုက်ရှိ အခန်းစေ့နေသူများ၏ ကန့်ကွက်မှုမရှိကြောင်း လက်မှတ်ရေးထိုးထားမှုစာ', false, frontFilesError, frontExplorer)
        : imagePreviewWidget(
            'ရေစက်မီတာလျှောက်ထားရာတွင် ကန်ထရိုက်ရှိ အခန်းစေ့နေသူများ၏ ကန့်ကွက်မှုမရှိကြောင်း လက်မှတ်ရေးထိုးထားမှုစာ', false, frontFiles, frontClear);
  }
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/yangon/contractor/overview',
