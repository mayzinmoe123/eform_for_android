...
class CForm11YCDC extends StatefulWidget {
  const CForm11YCDC({Key? key}) : super(key: key);

  @override
  State<CForm11YCDC> createState() => _CForm11YCDCState();
}

class _CForm11YCDCState extends State<CForm11YCDC> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(context, 'yng_c_form12_meter_bill',
