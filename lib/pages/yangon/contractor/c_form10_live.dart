...
class CForm10Live extends StatefulWidget {
  const CForm10Live({Key? key}) : super(key: key);

  @override
  State<CForm10Live> createState() => _CForm10LiveState();
}

class _CForm10LiveState extends State<CForm10Live> {
  int? formId;
  ...
  AppBar applicationBar() {
    return AppBar(
      centerTitle: true,
      title: const Text("လူနေထိုင်ခွင့် အထောက်အထား", style: TextStyle(fontSize: 18.0)),
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/yangon/contractor/c_form11_y_c_d_c',
