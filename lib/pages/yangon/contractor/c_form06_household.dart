...
class CForm06Household extends StatefulWidget {
  const CForm06Household({Key? key}) : super(key: key);

  @override
  State<CForm06Household> createState() => _CForm06HouseholdState();
}

class _CForm06HouseholdState extends State<CForm06Household> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(context, 'ygn_c_form07_recommend',
