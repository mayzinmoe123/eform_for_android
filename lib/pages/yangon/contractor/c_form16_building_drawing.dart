...
class CForm16BuildingDrawing extends StatefulWidget {
  const CForm16BuildingDrawing({Key? key}) : super(key: key);

  @override
  State<CForm16BuildingDrawing> createState() => _CForm16BuildingDrawingState();
}

class _CForm16BuildingDrawingState extends State<CForm16BuildingDrawing> {
  int? formId;
  ...
  Widget front() {
    return (frontFiles.length <= 0)
        ? multipleUploadWidget(
            'အဆောက်အဦး Drawing', true, frontFilesError, frontExplorer)
        : imagePreviewWidget(
            'အဆောက်အဦး Drawing', true, frontFiles, frontClear);
  }
