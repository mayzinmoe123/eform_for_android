...
class TForm12Zone extends StatefulWidget {
  const TForm12Zone({Key? key}) : super(key: key);

  @override
  State<TForm12Zone> createState() => _TForm12ZoneState();
}

class _TForm12ZoneState extends State<TForm12Zone> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/yangon/transformer/t_form13_power',
