...
class TForm10YCDC extends StatefulWidget {
  const TForm10YCDC({Key? key}) : super(key: key);

  @override
  State<TForm10YCDC> createState() => _TForm10YCDCState();
}

class _TForm10YCDCState extends State<TForm10YCDC> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/yangon/transformer/t_form11_farm_land',
