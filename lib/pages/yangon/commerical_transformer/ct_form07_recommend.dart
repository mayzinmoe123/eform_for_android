...
class CtForm07Recommend extends StatefulWidget {
  const CtForm07Recommend({Key? key}) : super(key: key);

  @override
  State<CtForm07Recommend> createState() => _CtForm07RecommendState();
}

class _CtForm07RecommendState extends State<CtForm07Recommend> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/yangon/commerical_transformer/ct_form08_ownership',
