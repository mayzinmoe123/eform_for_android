...
import 'package:flutter_application_1/pages/yangon/commerical_transformer/ct_form04_info.dart';
...
class _CtForm03MoneyState extends State<CtForm03Money> {
      ...
      child: ElevatedButton(
        onPressed: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => CtForm04Info()));
        },
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/yangon/commerical_transformer/ct_form04_info',
