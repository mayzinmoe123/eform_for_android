...
class CtForm05NRC extends StatefulWidget {
  const CtForm05NRC({Key? key}) : super(key: key);

  @override
  State<CtForm05NRC> createState() => _CtForm05NRCState();
}

class _CtForm05NRCState extends State<CtForm05NRC> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/yangon/commerical_transformer/ct_form06_household',
