...
class CtForm12Zone extends StatefulWidget {
  const CtForm12Zone({Key? key}) : super(key: key);

  @override
  State<CtForm12Zone> createState() => _CtForm12ZoneState();
}

class _CtForm12ZoneState extends State<CtForm12Zone> {
  int? formId;
  ...
  final noti = const Text(
    "စက်မှုဇုံမဟုတ်ပါက ဖြည့်သွင်းရန်မလိုအပ်ပါ။ စက်မှုဇုံမဟုတ်ပါက ဆက်လက်လုပ်ဆောင်မည် ကိုနှိပ်ပါ။",
  ...
  AppBar applicationBar() {
    return AppBar(
      centerTitle: true,
      title: const Text("ဇုံကော်မတီ၏ ထောက်ခံချက်",
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/yangon/commerical_transformer/ct_form13_power',
