...
class CtForm04Info extends StatefulWidget {
  const CtForm04Info({Key? key}) : super(key: key);

  @override
  State<CtForm04Info> createState() => _CtForm04InfoState();
}

class _CtForm04InfoState extends State<CtForm04Info> {
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/yangon/commerical_transformer/ct_form05_nrc',
