...
class CtForm11FarmLand extends StatefulWidget {
  const CtForm11FarmLand({Key? key}) : super(key: key);

  @override
  State<CtForm11FarmLand> createState() => _CtForm11FarmLandState();
}

class _CtForm11FarmLandState extends State<CtForm11FarmLand> {
  int? formId;
  ...
  final noti = const Text(
    "လယ်ယာပိုင်မြေမဟုတ်ပါက ဖြည့်သွင်းရန်မလိုအပ်ပါ။ လယ်ယာပိုင်မြေမဟုတ်ပါက ဆက်လက်လုပ်ဆောင်မည်ကို နှိပ်ပါ",
  ...
  AppBar applicationBar() {
    return AppBar(
      centerTitle: true,
      title: const Text("လယ်ယာပိုင်မြေ သုံးဆွဲခွင့်",
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/yangon/commerical_transformer/ct_form12_zone',
