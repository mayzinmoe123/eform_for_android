...
class CtForm06Household extends StatefulWidget {
  const CtForm06Household({Key? key}) : super(key: key);

  @override
  State<CtForm06Household> createState() => _CtForm06HouseholdState();
}

class _CtForm06HouseholdState extends State<CtForm06Household> {
  int? formId;
  ...
  void goToNextPage(formIdValue) async {
    final result = await Navigator.pushNamed(
        context, '/yangon/commerical_transformer/ct_form07_recommend',
