...
class CtForm08Ownership extends StatefulWidget {
  const CtForm08Ownership({Key? key}) : super(key: key);

  @override
  State<CtForm08Ownership> createState() => _CtForm08OwnershipState();
}

class _CtForm08OwnershipState extends State<CtForm08Ownership> {
  int? formId;
  ...
  void goToNextPage() async {
    final result = await Navigator.pushNamed(
        context, '/yangon/commerical_transformer/ct_form09_license',
