...
import 'application_form_building.dart';

// import 'package:open_file/open_file.dart';

class ApplicationFormFarmLand extends StatefulWidget {
  const ApplicationFormFarmLand({Key? key}) : super(key: key);

  @override
  State<ApplicationFormFarmLand> createState() =>
      _ApplicationFormFarmLandState();
}

class _ApplicationFormFarmLandState extends State<ApplicationFormFarmLand> {
  // PlatformFile? file;
  var imageFiles = [];
