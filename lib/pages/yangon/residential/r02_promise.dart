...
class R02Promise extends StatefulWidget {
  const R02Promise({Key? key}) : super(key: key);

  @override
  State<R02Promise> createState() => _R02PromiseState();
}

class _R02PromiseState extends State<R02Promise> {
  ...
  void goToNextPage(BuildContext context) {
    Navigator.pushNamed(context, '/yangon/residential/r03_money');
  }
