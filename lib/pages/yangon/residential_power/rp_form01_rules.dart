...
class RpForm01Rules extends StatefulWidget {
  const RpForm01Rules({Key? key}) : super(key: key);

  @override
  State<RpForm01Rules> createState() => _RpForm01RulesState();
}

class _RpForm01RulesState extends State<RpForm01Rules> {
  ...
  void goToNextPage(BuildContext context) {
    Navigator.pushNamed(context, '/yangon/residential_power/rp_form02_promise');
  }
