...
class RpForm06Household extends StatefulWidget {
  const RpForm06Household({Key? key}) : super(key: key);

  @override
  State<RpForm06Household> createState() => _RpForm06HouseholdState();
}

class _RpForm06HouseholdState extends State<RpForm06Household> {
  int? formId;
  bool edit = false;
