...
class RpForm08Ownership extends StatefulWidget {
  const RpForm08Ownership({Key? key}) : super(key: key);

  @override
  State<RpForm08Ownership> createState() => _RpForm08OwnershipState();
}
