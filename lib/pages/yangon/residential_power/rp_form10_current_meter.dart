...
class RpForm10CurrentMeter extends StatefulWidget {
  const RpForm10CurrentMeter({Key? key}) : super(key: key);

  @override
  State<RpForm10CurrentMeter> createState() => _RpForm10CurrentMeterState();
}
...
class _RpForm10CurrentMeterState extends State<RpForm10CurrentMeter> {
  ...
  AppBar applicationBar() {
    return AppBar(
      centerTitle: true,
      title: const Text("မီတာချလံဓါတ်ပုံ", style: TextStyle(fontSize: 18.0)),
